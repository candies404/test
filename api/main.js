...
app.get("/dashboard/api/*", async (req, res) => {
    ...
    if (authResult == false) {
        ...
        switch (apiPath) {
            ...
            case "/dashboard/api/getLinkList":
